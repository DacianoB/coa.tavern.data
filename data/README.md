...
Download `game.db.gz`, all seven `community-game.db.gz.part01` through `.part07`
files, and `manifest.json` from the same
...
hashes, join the numbered parts, and decompress. Run `npm run data:verify` for full schema/count/integrity
